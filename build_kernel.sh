...
export CROSS_COMPILE=/home/dev/KERNEL/arm-eabi-4.4.3/bin/arm-eabi-
...
rm ${KERNELDIR}/READY/.config
        ...
        if [ "$ADB_STATUS" == "device" ]; then
			...
			mv ${KERNELDIR}/READY/Kernel_* ${KERNELDIR}/GEAR/
			ncftpput -f /home/dev/login.cfg -V -R / ${KERNELDIR}/GEAR/
			rm ${KERNELDIR}/GEAR/Kernel_*
